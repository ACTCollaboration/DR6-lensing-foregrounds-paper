...
For the lensing power spectrum analysis, we closely follow the analysis choices of \citet{qu22, madhavacheril22}. We coadd the 90 and 150 GHz foreground-only maps with the same $l$-dependent weights used for the real data, and use the same (diagonal) filtering of the maps entering in the quadratic estimator.  We use a bias-hardened quadratic estimator 
